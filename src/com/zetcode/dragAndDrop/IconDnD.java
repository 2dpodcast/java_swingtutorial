package com.zetcode.dragAndDrop;
...
public class IconDnD extends JFrame {
	...
	public IconDnD() {
		...
		ImageIcon icon1 = new ImageIcon("./files/img/drive.png");
		ImageIcon icon2 = new ImageIcon("./files/img/printer.png");
		ImageIcon icon3 = new ImageIcon("./files/img/open.png");
